...
from capice.src.main.python.utilities.predictor import Predictor
from capice.src.main.python.utilities.class_suggestor import ClassSuggestor
from capice.src.main.python.validators.post_vep_processing_validator import PostVEPProcessingValidator
from capice.src.main_capice import Main
