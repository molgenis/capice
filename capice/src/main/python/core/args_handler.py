...
from capice.src.main.python.__version__ import __version__
from capice.src.main.python.core.capice_manager import CapiceManager
from capice.src.main.python.cli.args_handler_train import ArgsHandlerTrain
from capice.src.main.python.cli.args_handler_predict import ArgsHandlerPredict
