...
class Main:
    def __init__(self,
        ...
        if not self.manager.get_disable_logfile():
        ...
        self.log.info('Verbose -v / --verbose confirmed: {}'.format(self.verbose))
        ...
        self.force = force
        self.log.debug('Force flag confirmed: {}'.format(self.force))
